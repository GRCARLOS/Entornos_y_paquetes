...
# Esta versión plotea cuando se han realizado más alla de 3 iteraciones con resultados dentro 
# del umbral, para evitar graficar episodios de una sola iteración.
...
def qLearning(env,num_actions, num_episodios, discount_factor, alpha, epsilon,error_umbral,h,I_reference,x0,Tl):
    ...
    for ith_episode in range(num_episodios):
        ...
        posicion= env.reset()                 ## Posición inicial
        #posicion=np.array([9, 5])
        #env.self_agent_location(posicion)
